...
import { NFT_COLLECTION_FACTORY_V2_ABI } from "@/abi/NFTCollectionFactoryV2";
import {
  FACTORY_ADDRESS as FACTORY_ADDRESS_ENV,
  FACTORY_V2_ADDRESS as FACTORY_V2_ADDRESS_ENV,
...
export const FACTORY_V2_ADDRESS: Address | undefined = FACTORY_V2_ADDRESS_ENV;
